...
<nav class="navbar navbar-expand-lg bg-body-tertiary pt-0">
    <div class="container-fluid bg-success">
        ...
        <form action="home">
            <a class="navbar-brand text-white" href="home">Office 1</a>
        </form>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active text-white" aria-current="page" href="#">Log in</a>
                </li>
            </ul>
        </div>
    </div>
</nav>
    <form method="POST" action="/login" class="container d-flex flex-column align-items-center justify-content-center vh-100r">
